...
const APP_DEFAULT_TITLE =
    "Yum Nextjs - Multipurpose Food Tailwind CSS Template";
const APP_TITLE_TEMPLATE =
    "%s | Yum Nextjs - Multipurpose Food Tailwind CSS Template";
...
export default function RootLayout({ children }) {
    return (
        <html lang="en">
            ...
            <body
                className={`${inter.className} selection:bg-primary selection:text-white`}
            >
